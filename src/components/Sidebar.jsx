...
const TABS = [
  ...
  { id: 'media', label: 'Media', icon: <path d="M9 18V5l11-2v13" /> },
  ...
  { id: 'calendar', label: 'Calendar', icon: <path d="M16 3v4M8 3v4M3 10h18" /> },
  ...
  return (
    <nav id="tabstrip">
      <div className="brand">
        ...
        <div className="sub">⋆ keep going ⋆</div>
      </div>
      ...
      <div id="user-badge">{session?.user?.email || ''}</div>
